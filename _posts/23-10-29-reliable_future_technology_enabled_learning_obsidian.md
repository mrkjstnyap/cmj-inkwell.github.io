...
[Obsidian](https://obsidian.md/) is a writing app that uses simple markdown (.md) files as notes. When using Obsidian for the first time you will be prompted to create a **Vault** (i.e., a folder in your system). This folder will hold all your notes and sub folders. Every note that you create is be accessible via the interface in Obsidian without having to go through your folders and switching between windows. One thing that already stands out is that you do not have to connect to the internet to be able to use all its features. All your files are saved locally. You own your data and you have access to whatever information you have stored in your vault without needing to go through additional third party software and services. 
